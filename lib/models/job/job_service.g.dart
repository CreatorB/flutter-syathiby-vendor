...
class _JobRestInterface implements JobRestInterface {
  ...
  Future<DetailsJob> getDetailJob(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<DetailsJob>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late DetailsJob _value;
    try {
      _value = DetailsJob.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<Visiting> addVisiting(
    ...
    final _options = _setStreamType<Visiting>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late Visiting _value;
    try {
      _value = Visiting.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
